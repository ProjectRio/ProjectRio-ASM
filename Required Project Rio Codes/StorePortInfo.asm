...
# Inject: 0x80042CD0
START:
  lis r5, 0x802E                # Load init port P1 addr
  ori r5, r5, 0xBF91
  lis r3, 0x8089                # Load P1 CPU bool
  ori r3, r3, 0x2ACA
  lbz r3, 0(r3)
  cmpwi r3, 0x1                 # Is P1 CPU
  beq- SET_P1_CPU
  li r3, 0x1                    # If not CPU, set to 1 (P1)
  b SET_P2
...
SET_P2:
  stb r3, 0(r5)                 # Store P1 info to r5
  lis r3, 0x800E                # Get Px's port
  ori r3, r3, 0x874D
  lbz r3, 0(r3)                 
  addi r3, r3, 0x1              # Add 1 since we want P1 == 1 instead of 0
  stb r3, 1(r5)                 # Store Px info
  li r3, 0x1B8                  # Replace overwritten instruction
