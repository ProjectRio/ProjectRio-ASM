...
#define mfs_fielder value_atAddr(byte, 0x802EBF99) // MUST CHANGE ADDRESS, MEMORY CLAIMED

#define fielder_inputs value_atAddr(halfword, 0x8089289A) // R: 0x20, L: 0x40
